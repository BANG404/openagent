...
### Bug Fixes
- **native**: Satisfy current clippy boolean lint
...
### Bug Fixes
- **updater**: Map frontend navigation on Windows
- **settings**: Tailor initial window skeletons
...
### Bug Fixes
- **chat**: Stabilize streaming turn scrolling

## [0.38.3-beta.1] - 2026-08-14

### Bug Fixes
- **chat**: Preserve math in quoted selections

### Miscellaneous
- **sdk**: Advance formatting fix

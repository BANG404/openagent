...
- **Desktop application shell:** keep one compact, continuous top chrome across
  ...
  Settings opens from the application menu as a centered dialog over the
  mounted chat shell; the sidebar has no persistent Settings action. Conversation search spans all

...
- **Desktop application shell:** keep one compact, continuous top chrome across
  ...
  trailing minimize/maximize/close geometry.
  ...
  Projects; Settings and the former More destinations live only in the shared

...
- General model settings place the dedicated retry policy card immediately
  below the Flash model selection and before the Flash retry queue, separate
  from either model queue. The interval is displayed in seconds while preserving

---
name: openagent-design-system
description: Use when changing OpenAgent visual design, layout, typography, colors, component surfaces, responsive behavior, or DESIGN.md format and token handling.
metadata:

...
describe("release CI verification", () => {
  ...
  test("regenerates only Actions-generated stale release preparation branches", () => {
    expect(prepareReleaseWorkflow).toContain("Regenerating stale release preparation branch");
    expect(prepareReleaseWorkflow).toContain(
      '"github-actions[bot] <41898282+github-actions[bot]@users.noreply.github.com>"',
    );
    expect(prepareReleaseWorkflow).toContain("git push --force-with-lease");
    expect(prepareReleaseWorkflow).toContain(
      "Stale release preparation branch $branch was not generated by GitHub Actions",
    );
  });
